...
core_tLCDLayout GTS80_dispCaveman[] = {
  {0, 0, 2, 7,CORE_SEG98F | CORE_NODISP}, {0,16, 9, 7,CORE_SEG98F | CORE_NODISP},
  {4, 0,22, 7,CORE_SEG98F | CORE_NODISP}, {4,16,29, 7,CORE_SEG98F | CORE_NODISP},
  DISP_SEG_CREDIT(40,41,CORE_SEG9 | CORE_NODISP ), DISP_SEG_BALLS(42,43,CORE_SEG9 | CORE_NODISP),
  {0,0,240,256,CORE_VIDEO,(genf *)caveman_update,NULL},{0}
};
